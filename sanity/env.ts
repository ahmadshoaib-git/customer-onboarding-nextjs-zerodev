export const apiVersion = process.env.NEXT_PUBLIC_SANITY_API_VERSION || '2023-06-10';
...
export const token = assertValue(process.env.NEXT_PUBLIC_SANITY_TOKEN, 'Missing token');
